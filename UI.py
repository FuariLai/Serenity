...
def startUI():
    ...
    def fn2():
        ...
        with open(nowpath, "r", encoding="cp949") as f:
            ...
            if(keyvar.get() == "4"):
                ...
                if(modevar.get() == "1"):
                    showvalue.set(lines[105].strip())
                    now.set("ColumnStart: " + value.get() + "\n")
                    originvar.set("ColumnStart: 299")
                    root.after(10, onmode)
                elif(modevar.get() == "2"):
                    showvalue.set(lines[110].strip())
                    now.set("HitPosition: " + value.get() + "\n")
                ...
                if(modevar.get() == "1"):
                    showvalue.set(lines[172].strip())
                    now.set("ColumnStart: " + value.get() + "\n")
                    originvar.set("ColumnStart: 273")
                    root.after(10, onmode)
                elif(modevar.get() == "2"):
                    showvalue.set(lines[177].strip())
                    now.set("HitPosition: " + value.get() + "\n")
                    originvar.set("HitPosition: 444")
                    root.after(10, onmode)
                elif(modevar.get() == "3"):
                ...
                if(modevar.get() == "1"):
                    showvalue.set(lines[247].strip())
                    now.set("ColumnStart: " + value.get() + "\n")
                    originvar.set("ColumnStart: 247")
                    root.after(10, onmode)
                elif(modevar.get() == "2"):
                    showvalue.set(lines[252].strip())
                    now.set("HitPosition: " + value.get() + "\n")
                    originvar.set("HitPosition: 444")
                    root.after(10, onmode)
                elif(modevar.get() == "3"):
    ...
    def Imagemodify():
        if(modevar.get() == "5"): scale.State['normal']
        else: scale.State['normal']
    def option():
        if(keyvar.get() == "4"):
            if(modevar.get() == "1"):
    ...
    if os.path.exists(nowpath): pass
    else:
